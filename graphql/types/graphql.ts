...
export type StockQuery = { __typename?: 'Query', stock: { __typename?: 'Stock', id: number, productId: number, storeId: number, branchId: number, latestPriceId: number, createdAt: any, updatedAt: any, store?: { __typename?: 'Store', id: number, name: string, logo: string } | null, branch?: { __typename?: 'Branch', id: number, name: string, address: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string } } | null, latestPrice?: { __typename?: 'Price', id: number, productId: number, branchId: number, storeId: number, amount: number, currencyCode: string, sale: boolean, originalPrice?: number | null, condition?: string | null, expiresAt?: any | null, createdAt: any } | null, createdBy?: { __typename?: 'CreatedByUser', id: number, name: string, avatar?: string | null } | null, updatedBy?: { __typename?: 'UpdatedByUser', id: number, name: string, avatar?: string | null } | null } };
