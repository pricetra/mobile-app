...
export type CreatePriceMutation = { __typename?: 'Mutation', createPrice: { __typename?: 'Price', id: number, amount: number, currencyCode: string, productId: number, storeId: number, stockId: number, branchId: number, product?: { __typename?: 'Product', id: number, name: string, brand: string, category?: { __typename?: 'Category', id: number, expandedPathname: string } | null } | null, store?: { __typename?: 'Store', id: number, name: string } | null, branch?: { __typename?: 'Branch', id: number, name: string, address: { __typename?: 'Address', id: number, fullAddress: string } } | null } };
...
export type GetProductStocksQuery = { __typename?: 'Query', getProductStocks: { __typename?: 'PaginatedStocks', stocks: Array<{ __typename?: 'Stock', id: number, productId: number, storeId: number, branchId: number, latestPriceId: number, createdAt: any, updatedAt: any, store?: { __typename?: 'Store', id: number, name: string, logo: string } | null, branch?: { __typename?: 'Branch', id: number, name: string, address: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string, distance?: number | null } } | null, latestPrice?: { __typename?: 'Price', id: number, productId: number, branchId: number, storeId: number, amount: number, currencyCode: string, sale: boolean, originalPrice?: number | null, condition?: string | null, expiresAt?: any | null, unitType: string } | null, createdBy?: { __typename?: 'CreatedByUser', id: number, name: string, avatar?: string | null } | null, updatedBy?: { __typename?: 'UpdatedByUser', id: number, name: string, avatar?: string | null } | null }>, paginator: { __typename?: 'Paginator', next?: number | null, page: number, prev?: number | null, limit: number, total: number, numPages: number } } };
