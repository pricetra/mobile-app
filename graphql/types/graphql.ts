...
export type RegisterExpoPushTokenMutation = { __typename?: 'Mutation', registerExpoPushToken: { __typename?: 'User', id: string, name: string, email: string, avatar?: string | null, createdAt: any, updatedAt: any, active: boolean, authPlatform?: AuthPlatformType | null, authStateId?: string | null, expoPushToken?: string | null, role: UserRole, addressId?: string | null, address?: { __typename?: 'Address', id: string, latitude: number, longitude: number, mapsLink: string, fullAddress: string, city: string, administrativeDivision: string, zipCode: string, countryCode: string, country?: string | null } | null } };
