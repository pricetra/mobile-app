...
export type Query = {
  ...
  barcodeScan: Product;
  extractProductFields: ProductExtractionFields;
  findBranch: Branch;
...
export type ExtractProductFieldsQuery = { __typename?: 'Query', extractProductFields: { __typename?: 'ProductExtractionFields', brand: string, productName: string, weight?: string | null, category: string } };
