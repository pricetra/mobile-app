...
export type GetAllBranchListsByListIdQuery = { __typename?: 'Query', getAllBranchListsByListId: Array<{ __typename?: 'BranchList', id: string, listId: string, branchId: string, createdAt: any, branch?: { __typename?: 'Branch', id: string, name: string, address: { __typename?: 'Address', id: string, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string }, store?: { __typename?: 'Store', id: string, name: string, logo: string } | null } | null }> };
