...
export default function AuthFormContainer({
  ...
  return (
    <ScrollView className="h-screen w-screen bg-gray-50 py-10">
      <SafeAreaView>
        <View className="flex flex-col items-center justify-center gap-1 py-10">
          <View className="mb-5 flex flex-row items-center justify-center gap-5">
            ...
            <View className="h-[35px] w-[1px] bg-gray-200" />

            <Text className="text-center text-2xl font-bold">{title}</Text>
          </View>

          <View className="w-full rounded-lg px-7 py-10">
            <View className="flex flex-col gap-5">{children}</View>
          </View>

          <View className="flex w-full flex-col gap-5 rounded-lg p-7">{optionalContent}</View>
